...
- `client_example/`: a focused client generation example with a paired `server/` app and generated `client/` package, documented in [example/client_example/README.md](/Users/seven/workspace/spry/example/client_example/README.md)
