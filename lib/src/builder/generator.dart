...
Future<List<GeneratedFile>> generate(RouteTree tree, BuildConfig config) async {
  ...
  final hooks = StringBuffer()..writeln("// Generated by spry - do not edit.");
  if (tree.hooksPath case final hooksPath?) {
    hooks
      ..writeln(
        "import '${_relativeImport(hooksPath, from: outputDir)}' as \$source;",
      )
      ..writeln()
      ..writeln('final onStart = \$source.onStart;')
      ..writeln('final onStop = \$source.onStop;')
      ..writeln('final onError = \$source.onError;');
  } else {
    hooks
      ..writeln()
  ...
  final files = <GeneratedFile>[
    ...
    GeneratedFile(path: 'hooks.g.dart', content: hooks.toString()),
...
String _generateMain(BuildConfig config) {
  final runtimeImport = switch (config.target) {
    ...
    BuildTarget.vercel => "import 'package:osrv/esm.dart';",
  };
